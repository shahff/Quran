...
angular.module("main", ['ionic']).controller("mainController", main.mainController).controller("suraController", main.suraController).controller("suraIndexController", main.suraIndexController).controller("reciterController", main.reciterController).controller("translatorController", main.translatorController).service("appService", main.appService).service("suraService", main.suraService).service("reciterService", main.reciterService).service("translatorService", main.translatorService).config(function ($stateProvider, $urlRouterProvider) {
